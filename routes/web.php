...
Route::middleware(['auth', 'account.active'])->group(function () {
    ...
    Route::middleware('role:admin,teacher')->group(function () {
        ...
        Route::post('/classes/{classId}/ai-analysis', [ClassManagementController::class, 'analyzeLearningWithAi'])
            ->middleware('throttle:ai-generation')
            ->name('classes.ai-analysis');
    ...
    Route::middleware('role:admin,teacher')->group(function () {
        ...
        Route::get('/shared-documents/{sharedDocument}/preview', [SharedDocumentController::class, 'preview'])->name('shared-documents.preview');
    ...
    Route::middleware('role:admin,teacher')->group(function () {
        ...
        Route::post('/ai/teaching-content/generate', [AiTeachingContentController::class, 'generate'])
            ->middleware('throttle:ai-generation')
            ->name('ai.teaching-content.generate');
    });
    ...
    Route::delete('/submissions/{id}/delete', [AssignmentController::class, 'deleteSubmission'])
        ->middleware('role:student')
        ->name('assignments.submissions.delete');
    ...
    Route::middleware('role:admin,teacher')->group(function () {
        ...
        Route::post('/quizzes/ai-generate/process', [QuestionController::class, 'generateQuestions'])
            ->middleware('throttle:ai-generation')
    ...
    // Làm bài & Xem lại
    Route::get('/quizzes/{id}/attempt', [QuizAttemptController::class, 'create'])
        ->middleware('role:student')
